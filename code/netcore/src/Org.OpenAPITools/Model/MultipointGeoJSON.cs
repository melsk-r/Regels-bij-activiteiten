...
namespace Org.OpenAPITools.Model
{
    ...
    /// MultipointGeoJSON
    /// </summary>
    [DataContract(Name = "multipointGeoJSON")]
    public partial class MultipointGeoJSON : IEquatable<MultipointGeoJSON>, IValidatableObject
    {
        ...
        public MultipointGeoJSON(TypeEnum type = default(TypeEnum), List<List<decimal>> coordinates = default(List<List<decimal>>))
        {
            ...
            this.Coordinates = coordinates ?? throw new ArgumentNullException("coordinates is a required property for MultipointGeoJSON and cannot be null");
        }
