...
namespace Org.OpenAPITools.Model
{
    ...
    /// ActiviteitHalAllOf
    /// </summary>
    [DataContract(Name = "ActiviteitHal_allOf")]
    public partial class ActiviteitHalAllOf : IEquatable<ActiviteitHalAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ActiviteitHalAllOf);
        }

        /// <summary>
        /// Returns true if ActiviteitHalAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ActiviteitHalAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActiviteitHalAllOf input)
        {
            if (input == null)
                return false;
