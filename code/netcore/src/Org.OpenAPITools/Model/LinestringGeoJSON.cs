...
namespace Org.OpenAPITools.Model
{
    ...
    /// LinestringGeoJSON
    /// </summary>
    [DataContract(Name = "linestringGeoJSON")]
    public partial class LinestringGeoJSON : IEquatable<LinestringGeoJSON>, IValidatableObject
    {
        ...
        public LinestringGeoJSON(TypeEnum type = default(TypeEnum), List<List<decimal>> coordinates = default(List<List<decimal>>))
        {
            ...
            this.Coordinates = coordinates ?? throw new ArgumentNullException("coordinates is a required property for LinestringGeoJSON and cannot be null");
        }
