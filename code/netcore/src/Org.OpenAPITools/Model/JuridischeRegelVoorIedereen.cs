...
{
    /// <summary>
    /// &lt;body&gt;&lt;p&gt;De beschrijving van een regel met juridische werkingskracht. Een regel betreft binnen de Omgevingswet veelal activiteiten, en/of normen en/of functies en/of beperkingengebieden.&lt;/p&gt;&lt;/body&gt;
    /// </summary>
    ...
    public partial class JuridischeRegelVoorIedereen : IEquatable<JuridischeRegelVoorIedereen>, IValidatableObject
    {
        ...
        public JuridischeRegelVoorIedereen(DateTime begindatum = default(DateTime), DateTime einddatum = default(DateTime), List<string> gedefinieerdeLocatieIdentificaties = default(List<string>), Idealisatie idealisatie = default(Idealisatie), string identificatie = default(string), List<ActiviteitLocatieaanduiding> normeertActiviteiten = default(List<ActiviteitLocatieaanduiding>), string omschrijving = default(string), string regeltekstIdentificatie = default(string), List<Thema> themas = default(List<Thema>))
        {
            // to ensure "gedefinieerdeLocatieIdentificaties" is required (not null)
            this.GedefinieerdeLocatieIdentificaties = gedefinieerdeLocatieIdentificaties ?? throw new ArgumentNullException("gedefinieerdeLocatieIdentificaties is a required property for JuridischeRegelVoorIedereen and cannot be null");
