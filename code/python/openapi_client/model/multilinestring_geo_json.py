...
class MultilinestringGeoJSON(ModelNormal):
    ...
    def _from_openapi_data(cls, coordinates, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): defaults to "MultiLineString", must be one of ["MultiLineString", ]  # noqa: E501
        ...
        type = kwargs.get('type', "MultiLineString")
