...
class Regeltekst(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, document_component, identificatie, laatste_wijzigingsdatum, locatie_identificaties, omschrijving, werkpakket_code, *args, **kwargs):  # noqa: E501
