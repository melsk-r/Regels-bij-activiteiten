...
class WId(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """WId - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): <body><p>Identificatie datatype van de KOOP standaard.</p></body>.  # noqa: E501

        Keyword Args:
            value (str): <body><p>Identificatie datatype van de KOOP standaard.</p></body>.  # noqa: E501
