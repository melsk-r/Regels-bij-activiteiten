...
class RegeltekstEmbedded(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RegeltekstEmbedded - a model defined in OpenAPI
