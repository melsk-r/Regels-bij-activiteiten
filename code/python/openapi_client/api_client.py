...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ActiviteitenApi()
        api_instance.getactiviteit  # this is an instance of the class Endpoint
        api_instance.getactiviteit()  # this invokes api_instance.getactiviteit.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.getactiviteit.callable or self.callable in this class
