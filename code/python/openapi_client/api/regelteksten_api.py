    ...
    def __init__(self, api_client=None):
        ...
        def __getregeltekst(
            ...
            **kwargs
            ...
            Args:
                identificatie (Identificatie): <body><p>De unieke identificatie van de regeltekst in het OW-domein.</p></body>
        ...
        def __getregelteksten(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                expand (str): Hiermee kun je opgeven welke gerelateerde resources meegeleverd moeten worden, en hun inhoud naar behoefte aanpassen. Hele resources of enkele properties geef je in de expand parameter kommagescheiden op. Properties die je wil ontvangen geef je op met de resource-naam gevolgd door de property naam, met daartussen een punt. In de definitie van het antwoord kun je bij _embedded zien welke gerelateerde resources meegeleverd kunnen worden. Zie [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-common/blob/v1.2.0/features/expand.feature).. [optional]
                inclusief_vervallen (bool): <body><p>Als de parameter 'vanafdatum' een waarde heeft dan moet een evt. waarde van dit attribute worden genegeerd.</p></body>. [optional]
                omgevingsdocument_identificatie (str): <body><p>De unieke identificatie van de versie van het omgevingsdocument.</p></body>. [optional]
        ...
        self.getregelteksten = _Endpoint(
            ...
            params_map={
                'all': [
                    ...
                    'expand',
                    'inclusief_vervallen',
                    'omgevingsdocument_identificatie',
                    'page_size',
                    'werkpakket_code',
                ],
                'required': [],
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'page': 'page',
                    'expand': 'expand',
                    'inclusief_vervallen': 'inclusiefVervallen',
                    'omgevingsdocument_identificatie': 'omgevingsdocumentIdentificatie',
                    'page_size': 'pageSize',
                    'werkpakket_code': 'werkpakketCode',
                },
                'location_map': {
                    'accept_crs': 'header',
                    'page': 'query',
                    'expand': 'query',
                    'inclusief_vervallen': 'query',
                    'omgevingsdocument_identificatie': 'query',
                    'page_size': 'query',
                    'werkpakket_code': 'query',
                },
                'collection_format_map': {
                }
            },
