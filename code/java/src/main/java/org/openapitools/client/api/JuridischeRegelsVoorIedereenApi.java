...
public class JuridischeRegelsVoorIedereenApi {
     ...
     * @param identificatie &lt;body&gt;&lt;p&gt;De unieke identificatie van de juridischeRegelVoorIedereen.&lt;/p&gt;&lt;/body&gt;&lt;body&gt;&lt;p&gt;De verzameling van waarden die gegevens van dit attribuutsoort kunnen hebben, dat wil zeggen het waardenbereik, uitgedrukt in een specifieke structuur.&lt;/p&gt;&lt;/body&gt; (required)
