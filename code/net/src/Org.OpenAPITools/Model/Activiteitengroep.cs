...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Activiteitengroep :  IEquatable<Activiteitengroep>, IValidatableObject
    {
        ...
        public Activiteitengroep(string code = default(string), string waarde = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for Activiteitengroep and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (waarde == null)
            {
                throw new InvalidDataException("waarde is a required property for Activiteitengroep and cannot be null");
            }
            else
            {
                this.Waarde = waarde;
